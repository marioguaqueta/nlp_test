...
def train():
    parser = argparse.ArgumentParser(description="Fine-tune or continue training Qwen model")
    
    # Model and training
    parser.add_argument("--model_name", type=str, default=MODEL_NAME, help="Base model name or path")
    parser.add_argument("--resume_from", type=str, default=None, 
                        help="Path to checkpoint to resume from (e.g., models/qwen_finetuned)")
    parser.add_argument("--epochs", type=int, default=5, help="Number of ADDITIONAL training epochs")
    parser.add_argument("--batch_size", type=int, default=4, help="Per device training batch size")
    parser.add_argument("--gradient_accumulation_steps", type=int, default=4, help="Gradient accumulation steps")
    parser.add_argument("--learning_rate", type=float, default=1e-4, 
                        help="Learning rate (lower for fine-tuning existing model)")
    
    # LoRA parameters (only used if NOT resuming)
    ...
    parser.add_argument("--warmup_ratio", type=float, default=0.05, 
                        help="Warmup ratio (lower for fine-tuning)")
    ...
    mode = "resume" if is_resuming else "new"
    run_name = f"qwen-{mode}-r{args.lora_r}-lr{args.learning_rate}"
    ...
    print(f"Epochs: {args.epochs} additional")
    ...
    if is_resuming:
        ...
        # Configure new LoRA
        print(f"Configuring new LoRA (r={args.lora_r}, alpha={args.lora_alpha})...")
    ...
    training_args = TrainingArguments(
        ...
        save_strategy="epoch",
        save_total_limit=3,  # Keep more checkpoints when resuming
